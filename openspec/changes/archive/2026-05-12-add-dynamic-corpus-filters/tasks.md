...
- [x] **Task 6.2**: Verify manifest loading works correctly (requires runtime test)
- [x] **Task 6.3**: Test API /api/config endpoint returns correct corpus options (requires runtime test)
- [x] **Task 6.4**: Test API /api/retriever/filters endpoint returns correct filters (requires runtime test)
- [x] **Task 6.5**: Test query with each corpus filter value (requires runtime test)
- [x] **Task 6.6**: Test behavior with missing manifest (requires runtime test)
